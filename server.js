...
//   TMDB CONFIG
// ================================
const TMDB_API_KEY = process.env.TMDB_API_KEY || "8e2a8bd8a2d86bf25a910ded071e59d9";
...
app.get("/movie", async (req, res) => {
    ...
    const url = `${TMDB_BASE}/search/movie?api_key=${TMDB_API_KEY}&query=${encodeURIComponent(q)}`;
...
app.get("/movies/search", async (req, res) => {
    ...
    const url = `${TMDB_BASE}/search/movie?api_key=${TMDB_API_KEY}&query=${encodeURIComponent(q)}&page=${page}`;
    const data = await safeFetchJson(url);
